...
function PasswordGenerator(props) {
  ...
  return (
    <div className=" absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-black bg-opacity-30 backdrop-blur-[2px] text-white border-[#00eaff] border-b-[1px] border-r-2  w-80 max-w-[90%]  shadow-inner shadow-teal-950">
